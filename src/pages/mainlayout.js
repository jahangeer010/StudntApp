...
import OneNews from "./dashboardscreens/onenews";
import NEWS from "./dashboardscreens/news";
import StudentRegForm from "./dashboardscreens/StudentRegForm";
    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Routes>
          ...
          <Route path="StudentRedForm" element={<StudentRegForm/>} />
